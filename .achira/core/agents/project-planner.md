...
> 💡 **Script paths are relative to `.achira/` directory**
...
# P1: UX Audit
python .achira/core/skills/frontend-design/scripts/ux_audit.py .

# P3: Lighthouse (requires running server)
python .achira/core/skills/performance-profiling/scripts/lighthouse_audit.py http://localhost:3000

# P4: Playwright E2E (requires running server)
python .achira/core/skills/webapp-testing/scripts/playwright_runner.py http://localhost:3000 --screenshot
```
