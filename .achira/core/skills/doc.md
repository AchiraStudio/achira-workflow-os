...
| ------------- | --------------------------------- | ------------------------------------ |
| **Workspace** | `<workspace-root>/.achira/core/skills/` | Available only in a specific project |
...
```bash
mkdir -p .achira/core/skills/code-review
```
...
```bash
mkdir -p .achira/core/skills/license-header-adder/resources
```

### Step 2: Create the template file

**`.achira/core/skills/license-header-adder/resources/HEADER.txt`**:
...
**`.achira/core/skills/license-header-adder/SKILL.md`**:
