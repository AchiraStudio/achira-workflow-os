...
| 2    | Did I READ the agent's `.md` file (or recall its rules)? | → STOP. Open `.achira/core/agents/{agent}.md` |
...
> 🔴 **Agents & Skills can invoke ANY script** via `python .achira/core/skills/<skill>/scripts/<script>.py`
